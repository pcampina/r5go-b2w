...
<head>
    ...
    <style>
        body {
            ...
            background-image:url('https://i.ibb.co/SfCqdKQ/I2-Pii86-Uz-CYJsi-J3-Wq-WC.jpg');
            ...
            <div class="clearfix">
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                        ...
                        <img class="img-responsive pull-left flip logo hidden-xs animated fadeIn" src="https://i.ibb.co/LNsSdJ6/icon-512x512.png" alt="Logo Icon">
                        @endif
